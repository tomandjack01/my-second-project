...
import dgl
from dgl.nn import GINConv  # type: ignore[attr-defined]
from dgl.nn import GATConv  # type: ignore[attr-defined]
from dgl.nn import EGATConv  # type: ignore[attr-defined]
    ...
    def forward(self, g, x_t, time_embed):
        ...
        for l in range(self.num_layers):
            ...
            if h_t.ndim > 2:
                ...
                pass
            h_t = self.up_layers[l](g, h_t)  # type: ignore[index]
            h_t = h_t.flatten(1)
